        ...
        .controller('myCtrl', function (Resources, $location, $scope, $http, ngDialog, txtContent, $rootScope, $interval, $timeout, dropdownMenuBarInit, AuthService) {
            ...
            $scope.confirmPassword = function (){
              ...
              $http.post(url,postdata).success(function(response){
                ...
                /* Código cuando introducimos la password y es correcta. Funciona */
                if(MD5(String(password)) === userConf.pswd){
                    $scope.isLoged = "true";
                  ...
                  else if(MD5(String(password)) !== userConf.pswd && response.userPass !== null){
                    $scope.isLoged = "false";
                    //$scope.copyPassPlaceholder = '';
                  ...
                  /* Código de inicio del timeout. Funciona */

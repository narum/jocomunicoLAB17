var app = angular.module('controllers');
    app.controller('addWordVerb', function ($scope, $rootScope, txtContent, $location, $http, $interval, ngDialog, dropdownMenuBarInit, AuthService, Resources, $timeout) {
        ...
        txtContent("addWordVerb").then(function (results) {
